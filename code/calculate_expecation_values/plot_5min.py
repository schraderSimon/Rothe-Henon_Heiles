...
reference=30
i=20
autocorrelation_file=np.load("../../outputs/autocorrelation_dimension=3_dt=0.010_epsilon=1000.000_lambda=0.112_initlen=20_startpos=2.00.h5.npz")
...
ax.plot(xf_Simen, np.real(yf_Simen[:NSimen // 2]),linestyle=gridstyle,linewidth=gridlinewidth, label="Grid", color=gridcolor, alpha=alpha)
