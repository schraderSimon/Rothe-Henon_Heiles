...
if not parallel1=="parallel":
    ...
    filename1="../../outputs/data_dimension=%d_dt=%.3f_epsilon=%.3f_lambda=%.3f_initlen=%d_startpos=%.2f.h5"%(dimension,timestep,epsilon,lambda_,len_initial1,startpos)
else:
    filename1="../../outputs/paralleldata_dimension=%d_dt=%.3f_epsilon=%.3f_lambda=%.3f_initlen=%d_startpos=%.2f.h5"%(dimension,timestep,epsilon,lambda_,len_initial1,startpos)
if parallel2=="parallel":
    print("Not parallel: %s"%parallel2)
    filename2="../../outputs/paralleldata_dimension=%d_dt=%.3f_epsilon=%.3f_lambda=%.3f_initlen=%d_startpos=%.2f.h5"%(dimension,timestep,epsilon,lambda_,len_initial2,startpos)
elif parallel2=="nokinetic" or parallel2=="noKinetic":
    filename2="../../outputs/nokineticdata_dimension=%d_dt=%.3f_epsilon=%.3f_lambda=%.3f_initlen=%d_startpos=%.2f.h5"%(dimension,timestep,epsilon,lambda_,len_initial2,startpos)
...
if parallel2=="noKinetic" or parallel2=="nokinetic":
    outname="../../outputs/nokineticfidelity_dimension=%d_dt=%.3f_epsilon=%.3f_lambda=%.3f_len1=%d_len2=%d_startpos=%.2f_noKinetic.h5"%(dimension,timestep,epsilon,lambda_,len_initial1,len_initial2,startpos)
else:
    outname="../../outputs/fidelity_dimension=%d_dt=%.3f_epsilon=%.3f_lambda=%.3f_len1=%d_len2=%d_startpos=%.2f.h5"%(dimension,timestep,epsilon,lambda_,len_initial1,len_initial2,startpos)
