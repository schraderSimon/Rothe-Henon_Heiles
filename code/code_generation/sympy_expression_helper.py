...
Pj_deriv=cj_deriv+4*Sum(omega_deriv[k]*r[k],(k,1,N))-2*Sum(Asquared_deriv[k,l]*r[k]*r[l],(k,1,N),(l,1,N))
...
HenonHeilesPotential=1/2*Sum(r[o]*r[o],(o,1,N))-lambda_/3*Sum(r[o+1]*r[o+1]*r[o+1],(o,1,N-1))+lambda_*Sum(r[o]*r[o]*r[o+1],(o,1,N-1))
