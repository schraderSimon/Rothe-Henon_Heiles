...
filename="../outputs/data_dimension=%d_dt=%.3f_epsilon=%.3f_lambda=%.3f_initlen=%d_startpos=%.2f.h5"%(dimension,timestep,epsilon,lambda_,len_initial,start_pos)
err_t0=0
...
timeEvolver=TimeEvolution(wave_function,h=timestep,T=Tfinal,epsilon=epsilon,t0=t0,error_t0=err_t0,filename=filename,dimension=dimension)
